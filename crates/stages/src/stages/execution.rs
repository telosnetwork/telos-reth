...
impl<EF: ExecutorFactory> ExecutionStage<EF> {
    ...
    pub fn execute_inner<DB: Database>(
        ...
        for block_number in start_block..=max_block {
            ...
            executor.execute_and_verify_receipt(&block, td, #[cfg(feature = "telos")] None, #[cfg(feature = "telos")] None, #[cfg(feature = "telos")] None, #[cfg(feature = "telos")] None, #[cfg(feature = "telos")] None, #[cfg(feature = "telos")] None).map_err(|error| StageError::Block {
