...
impl StorageInner {
        ...
        EvmConfig: ConfigureEvm,
    {
        ...
        let (receipts, gas_used) = executor.execute_transactions(block, U256::ZERO, #[cfg(feature = "telos")] None, #[cfg(feature = "telos")] None, #[cfg(feature = "telos")] None, #[cfg(feature = "telos")] None)?;
